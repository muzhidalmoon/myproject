<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($numExistRows > 0){
          ...
          if(validName($username) && validEmail($email) && validPassword($password,$cpassword)){
              $hashPassword = password_hash($password, PASSWORD_DEFAULT);
              $sql = "INSERT INTO user_01 (username, email, password, date) VALUES('$username', '$email', '$hashPassword', current_timestamp())";
              session_start();
